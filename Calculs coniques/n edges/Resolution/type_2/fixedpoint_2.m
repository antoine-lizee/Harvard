function [ solution values  ] = fixedpoint_2( n, gamma, H1 )
...
%
%This version is the declination of fixedpoint for research of solution of
%type 2. The differences lay in r and r2 and in the relation between theta1
%and theta2.
%
...
gamma=gamma/180*pi;
    ...
    function [theta2]=theta1_2(theta1)
        theta2=(2*pi-floor(n/2)*theta1-gamma)/ceil(n/2);
    end
