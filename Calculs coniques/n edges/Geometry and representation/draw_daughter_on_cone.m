function [ VF VFd] = draw_daughter_on_cone( V, A, p, gen )
...
%give as an additional output the auto-similar daughter cell. Actually, it 
%is computed as the main solution reduced in a sqrt(2) ratio, and
%rotated by the appropriate theta angle (see end of the function). It is,
%thus, a powerful demonstration of the success of the solution determination.
%
...
Vfdtheta=Vftheta-gen*solution.theta1*pi/180*r;
