...
%--------------------------------------------------------------------------
% This is a mixed version between two files. The first one is the present
% function, which does not work anymore because of issues related to
% version of MATLAB (which does not support dlls anymore) and OS (no C
% version for 64 bits OS). We use for the core function the java based
% program listed in the private folder.
%
%Copyright Antoine Lizée, @ Dumais Lab, OEB Dept, Harvard University
%
%====================================================================
%
...
%         set(h(n),'Name',figName,'NumberTitle',numTitle);
    ...
    error('cannot maximize the root window with the java-based program');
